...
<body>
    <header class="hero">
        <div class="container hero-content">
            ...
            <div class="hero-actions">
                <button type="button" class="btn btn-register" data-scroll-target="registration">
                    Записаться на курс
                </button>
                <button type="button" class="btn btn-secondary" data-scroll-target="pricing">
                    Смотреть тарифы
                </button>
            </div>
    ...
    <main>
        <section class="section">
            <div class="container">
                ...
                <div class="cta-strip">
                    <p>Готовы записаться или сначала сравнить форматы участия?</p>
                    ...
                    <article class="program-module">
                        <details>
                            <summary>
                                ...
                                <span class="program-teaser">Как безопасно подойти к происшествию и не навредить себе и пострадавшему.</span>
                            </summary>
                            <p>
                    ...
                    <article class="program-module">
                        <details>
                            <summary>
                                ...
                                <span class="program-teaser">Практика СЛР и работа с тренировочным AED до автоматизма.</span>
                            </summary>
                            <p>
                    ...
                    <article class="program-module">
                        <details>
                            <summary>
                                ...
                                <span class="program-teaser">Реальные истории из практики и ответы на «страшные» вопросы.</span>
                            </summary>
                            <p>
                    ...
                    <article class="program-module">
                        <details>
                            <summary>
                                ...
                                <span class="program-teaser">Давящая повязка, турникет и признаки шока на практике.</span>
                            </summary>
                            <p>
                    ...
                    <article class="program-module">
                        <details>
                            <summary>
                                ...
                                <span class="program-teaser">Иммобилизация подручными средствами и помощь при ожогах.</span>
                            </summary>
                            <p>
                    ...
                    <article class="program-module">
                        <details>
                            <summary>
                                ...
                                <span class="program-teaser">Сценарии «как в жизни» и вручение сертификатов.</span>
                            </summary>
                            <p>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="cta-strip">
                    <p>Дальше — тарифы и запись. Места в группе ограничены.</p>
                    <div class="cta-strip-actions">
                        <button type="button" class="btn btn-register" data-scroll-target="registration">Записаться</button>
                        <button type="button" class="btn btn-secondary" data-scroll-target="pricing">Смотреть тарифы</button>
                    </div>
        ...
        <section class="section legal-section">
            <div class="container">
                ...
                <p class="section-lead">
                    Закон защищает добросовестного помощника. На курсе разбираем, как действовать
                    уверенно и в разумных пределах своих возможностей.
                </p>
                <ul class="legal-highlights">
                    <li>Если вы помогаете без грубой неосторожности — закон на вашей стороне.</li>
                    <li>Разберём, какие действия разумны и когда лучше дождаться медиков.</li>
                    <li>Научим, что сказать диспетчеру и какие факты сохранить для медиков.</li>
                </ul>
                <details class="legal-details">
                    <summary>Подробнее о блоке на курсе</summary>
        ...
        <section class="section registration-section" id="registration">
            <div class="container">
                <div class="registration-panel">
                    ...
                    <p class="section-lead">
                        Оставьте контакты — перезвоним, подтвердим место и ответим на вопросы.
                    ...
                    <form class="form-grid" id="registration-form" action="api/submit.php" method="post">
                        ...
                        <label>
                            Телефон
                            <input type="tel" name="phone" required autocomplete="tel" placeholder="+7 …">
                        </label>
                        <label>
                            E-mail
                            <input type="email" name="email" required autocomplete="email" placeholder="для подтверждения записи">
                        </label>
                        <label>
                            Цель прохождения курса
                            <span class="field-hint">Коротко: для себя, семьи, работы или корпоратива</span>
                            <textarea name="purpose" required placeholder="Например: хочу уметь помочь близким / нужна практика для работы"></textarea>
                        </label>
                        <button type="submit" class="btn">Отправить заявку</button>
                    </form>
                    <p class="form-trust">Ответим в течение дня · место не списывается автоматически</p>
    ...
    <script type="text/javascript">
        ...
        })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=110949451', 'ym');

        ym(110949451, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
    </script>
